package com.example.automatictools.activity.service;
...
import com.example.automatictools.activity.view.FloatingView;
...
public class AutoService extends AccessibilityService {
    ...
    private String TAG = "AutoService";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (SHOW.equals(action)) {
                ...
                mInterval = intent.getIntExtra("interval", 16) * 60;
                ...
                mInterval = intent.getIntExtra("interval", 16) * 100;
                ...
                Log.e(TAG, "onStartCommand: x=" + mX);

                Log.e(TAG, "onStartCommand: y=" + mY);
